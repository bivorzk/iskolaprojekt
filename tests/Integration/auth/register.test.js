...
// Mock User modell, teljesen self-contained
...
describe('POST /auth/register', () => {
  ...
  it('should fail with missing username or password', async () => {
    ...
    expect(res.text).toMatch(/Username and password are required/);
  });
  ...
  it('should return 429 if rate limit exceeded', async () => {
    ...
    expect(res.text).toMatch(/Too many registration attempts/);
  });
