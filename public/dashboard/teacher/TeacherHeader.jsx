const TeacherHeader = ({ welcomeMessage }) => {
    return (
                ...
                <div className="flex items-center space-x-4 px-4 sm:px-6 lg:px-8">
                    <a href="/">
                        <svg viewBox="0 0 500 140" className="h-20 w-auto">
                            ...
                            <text x="150" y="105" fontFamily="system-ui, -apple-system, sans-serif" fontSize="20" fill="#6C757D" letterSpacing="2">TEACHER PANEL</text>
                        </svg>
                    </a>
                </div>
                <div className="flex items-center space-x-4 pr-4 sm:pr-6 lg:pr-8">
                    <span className="text-gray-700">{welcomeMessage || 'Welcome, Teacher'}</span>
