...
const useAdminData = () => {
    ...
    const loadDashboardData = async () => {
        try {
            const [userCountRes, ordersRes, userListRes, signupStatsRes, menuItemsRes, welcomeRes, mostBoughtItemsRes, mostBoughtItemsLastWeekRes, revenueLastMonthRes, averageOrderValueRes, totalRevenueRes] = await Promise.all([
            ...
            const [userCount, orders, userList, signupStats, menuData, welcome, mostBoughtItems, mostBoughtItemsLastWeek, revenueLastMonth, averageOrderValue, totalRevenue] = await Promise.all([
                userCountRes.json(),
                ordersRes.json(),
                userListRes.json(),
                signupStatsRes.json(),
            ...
            console.log('API responses:', { userCount, orders, userList, signupStats, menuData, welcome, mostBoughtItems, mostBoughtItemsLastWeek, revenueLastMonth, averageOrderValue, totalRevenue });
