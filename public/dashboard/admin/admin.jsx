                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        <div className="flex items-center space-x-4">
                            <svg viewBox="0 0 500 140" className="h-16 w-32">
                                ...
                                <text x="150" y="100" fontFamily="system-ui, -apple-system, sans-serif" fontSize="10" fill="#6C757D" letterSpacing="2">ADMIN PANEL</text>
                            </svg>
                        </div>
                        <div className="flex items-center space-x-4">
