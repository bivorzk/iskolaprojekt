...
const EditorHeader = ({ welcomeMessage, userData }) => {
            ...
            <div className="flex flex-wrap justify-between items-center gap-3 py-3 w-full px-3 sm:px-6 lg:px-8">
                <div className="flex items-center gap-2 sm:gap-4 min-w-0 shrink-0">
                    ...
                    <svg viewBox="0 0 500 140" className="h-16 sm:h-20 lg:h-20 w-auto shrink-0">
                        ...
                        <text x="150" y="105" fontFamily="system-ui, -apple-system, sans-serif" fontSize="20" fill="#6C757D" letterSpacing="2" className="hidden sm:inline">EDITOR PANEL</text>
                    </svg>
                    </a>
                </div>
