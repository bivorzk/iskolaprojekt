...
router.post("/login", async (req, res) => {
  try {
    ...
    console.log(
      ...
      clientIp,
      geo ? `Location: ${geo.country}` : "Location: unknown",
    );
    ...
    if (!ipMatches && lastLog) {
      ...
      await createSecurityLog({
        ...
        type: "WARNING",
        details:
          "Login attempt from different IP address" || "First login for user",
        country: geo ? geo.country : "unknown",
        CountryCode: geo ? geo.country_code : "unknown",
        currency: geo ? geo.currency_code : "unknown",
        Continent: geo ? geo.continent : "unknown",
        IsVPN: geo ? geo.privacy.is_vpn : false,
        isTor: geo ? geo.privacy.is_tor : false,
        isProxy: geo ? geo.privacy.is_proxy : false,
